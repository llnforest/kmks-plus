<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="编号" align="center" prop="infoId" width="55"/>
      ...
      <el-table-column label="登录地址" align="center" prop="ipaddr" width="130" :show-overflow-tooltip="true" min-width="120"/>
      ...
      <el-table-column label="操作信息" align="center" prop="msg"  :show-overflow-tooltip="true" min-width="200"/>
...
export default {
  ...
  methods: {
    ...
    handleExport() {
     ...
     /** 导出统计信息 */
  handleState(){
    this.download('monitor/logininfor/export/state', {
      ...this.queryParams
    }, `logininfor_state_${new Date().getTime()}.xlsx`)
  },

<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="cdxmbhList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="公安代码" align="center" prop="gakfdm" />
            <el-table-column label="扣分名称" align="center" prop="kfmc" min-width="300" />
            <el-table-column label="考试项目" align="center" prop="ksxm"/>
            <el-table-column label="项目名称" align="center" prop="xmmc" />
            <el-table-column label="num1" align="center" prop="num1" />
            <el-table-column label="num2" align="center" prop="num2" />
            <el-table-column label="num" align="center" prop="num" />
            <el-table-column label="nums1" align="center" prop="nums1" />
            <el-table-column label="nums2" align="center" prop="nums2" />
            <el-table-column label="nums" align="center" prop="nums" />
            <el-table-column label="num2" align="center" prop="num2" />
            <el-table-column label="bl1" align="center" prop="bl1" />
            <el-table-column label="bl2" align="center" prop="bl2" />
            <el-table-column label="bl" align="center" prop="bl" />
            <el-table-column label="totalRatio" align="center" prop="totalRatio" />
        </el-table>
...
import { getTotalKfCodeReport } from "@/api/w2/ksxmdmJg";
export default {
    name: "Cdxmbh",
    data() {
        return {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            getTotalKfCodeReport(this.queryParams).then(response => {
                this.cdxmbhList = response.rows;
                this.total = response.total;
                this.loading = false;
                console.log(this.cdxmbhList)
            });
        },
        // 取消按钮
        cancel() {

<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="配置说明" prop="kfmc">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['w2:kfconfigk2program:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['w2:kfconfigk2program:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['w2:kfconfigk2program:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="kfconfigList" @selection-change="handleSelectionChange" @row-click="rowClick" @row-contextmenu="rightClick">
      ...
      <el-table-column label="配置说明" align="center" prop="kfmc" min-width="300"/>
      <el-table-column label="参数值" align="center" prop="value" min-width="150"/>
      <el-table-column label="参数说明" align="center" prop="beizhu" min-width="300"/>
    ...
    <div id="menu" class="menuDiv" v-show="rightMenuVisible" :style="{top:rightMenuTop,left:rightMenuLeft}">
      <ul class="menuUl">
        <li v-hasPermi="['w2:kfconfigk2program:edit']"
            @click="handleUpdate(activeRow)"
        >
          修改
        </li>
        <li v-hasPermi="['w2:kfconfigk2program:remove']"
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="参数说明" prop="beizhu">
          {{form.beizhu}}
        </el-form-item>
      </el-form>

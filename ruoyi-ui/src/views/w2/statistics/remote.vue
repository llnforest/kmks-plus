<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="cdxmbhList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="事项" align="center" prop="field" />
            <el-table-column label="人数" align="center" prop="num" />
            <el-table-column label="比例(百分比)" align="center" prop="percentage" />
...
import {remote} from "@/api/w2/records";
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            remote(this.queryParams).then(response => {

...
public class SysUser extends BaseEntity {
     ...
     * 用户性别
     */
    @Column(value = "用户性别",dict = "sys_user_sex")
    private String sex;
     ...
     */
    @ValidField
    @Column(value = "是否是警员",dict = "sys_yes_no")
    ...
    /**
     * @Description 上一次登录的Ip和时间
     * @Param 
     * @return 
     * @Author lynn 13:51 2023/3/13
    **/
    @TableField(exist = false)

<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['w2:kfconfigk2province:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['w2:kfconfigk2province:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['w2:kfconfigk2province:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="kfconfigList" @selection-change="handleSelectionChange" @row-click="rowClick" @row-contextmenu="rightClick">
      ...
      <el-table-column label="扣分代码" align="center" prop="gakfdm" />
    ...
    <div id="menu" class="menuDiv" v-show="rightMenuVisible" :style="{top:rightMenuTop,left:rightMenuLeft}">
      <ul class="menuUl">
        <li v-hasPermi="['w2:kfconfigk2province:edit']"
            @click="handleUpdate(activeRow)"
        >
          修改
        </li>
        <li v-hasPermi="['w2:kfconfigk2province:remove']"
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="扣分代码" prop="gakfdm">
          {{form.gakfdm}}
        </el-form-item>

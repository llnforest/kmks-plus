...
//        parameterMap.put("kskm",w2RecordsVo.getKskm().equals("3")?"科目三道路驾驶技能考试":"科目二场地驾驶技能考试");
        ...
        parameterMap.put("kscj",w2RecordsVo.getKscj1()+String.format("（%s）",w2RecordsVo.getJgfs1()));
        ...
        // 补考参数设置
        if(!w2RecordsVo.getKscj1().equals("合格")){
//            parameterMap.put("bkkskm",w2RecordsVo.getKskm().equals("3")?"科目三道路驾驶技能补考":"科目二场地驾驶技能补考");
            ...
            parameterMap.put("bkkscj", w2RecordsVo.getKscj2()+String.format("（%s）",w2RecordsVo.getJgfs2()));
            // 第二次考试三张照片
...
//        String headEncode = Base64.encode(new File("C:\\Users\\Star\\Desktop\\image\\2.jpg"));
        // 门禁照片
        parameterMap.put("headImg",webService.downUpInfo(String.format("$CZ;3002;%s;%s;%s", w2RecordsVo.getZjhm(),w2RecordsVo.getYkrq(),"2")));
        // 第一次考试三张照片
...
//        webService.downUpInfo("$CZ;3002;211022198511034902;2019-09-16 00:00:00;4");
    ...
    public R<List<W2FlowVo>> flowList(String bh, String ksrq){
        return R.ok(iW2RecordsService.getFlowList(bh,ksrq));
    }

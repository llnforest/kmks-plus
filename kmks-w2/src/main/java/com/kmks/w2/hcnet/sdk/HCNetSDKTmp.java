...
public interface HCNetSDKTmp extends Library {
...
//智能设备类型
    ...
    public static class NET_DVR_PICCFG extends Structure { //图片参数结构体
    ...
    public static class NET_DVR_BASEMAP_CFG extends Structure { //原图参数结构体
...
//IPC接入参数配置
    ...
    public class NET_DVR_IPDEVINFO_V31 extends Structure {
        ...
        public byte[] sUserName = new byte[HCNetSDKTmp.NAME_LEN];//用户名
        public byte[] sPassword = new byte[HCNetSDKTmp.PASSWD_LEN];//密码
        public byte[] byDomain = new byte[HCNetSDKTmp.MAX_DOMAIN_NAME];//设备域名
        public NET_DVR_IPADDR struIP = new NET_DVR_IPADDR();//IP地址
        public short wDVRPort;//端口号
    ...
    public class NET_DVR_IPSERVER_STREAM extends Structure {
        ...
        public byte[] byDVRName = new byte[HCNetSDKTmp.NAME_LEN];
        public short wDVRSerialLen;
        public short[] byRes1 = new short[2];
        public byte[] byDVRSerialNumber = new byte[HCNetSDKTmp.SERIALNO_LEN];
        public byte[] byUserName = new byte[HCNetSDKTmp.NAME_LEN];
        public byte[] byPassWord = new byte[HCNetSDKTmp.PASSWD_LEN];
        public byte byChannel;
    ...
    public class NET_DVR_DEV_CHAN_INFO extends Structure {
        ...
        public byte[] byDomain = new byte[HCNetSDKTmp.MAX_DOMAIN_NAME];//设备域名
        public byte[] sUserName = new byte[HCNetSDKTmp.NAME_LEN];//设备登陆帐号
        public byte[] sPassword = new byte[HCNetSDKTmp.PASSWD_LEN];//设备密码
    }
    ...
    public class NET_DVR_DDNS_STREAM_CFG extends Structure {
        ...
        public byte[] sDVRName = new byte[HCNetSDKTmp.NAME_LEN];
        public short wDVRNameLen;
        public short wDVRSerialLen;
        public byte[] sDVRSerialNumber = new byte[HCNetSDKTmp.SERIALNO_LEN];
        public byte[] sUserName = new byte[HCNetSDKTmp.NAME_LEN];
        public byte[] sPassWord = new byte[HCNetSDKTmp.PASSWD_LEN];
        public short wDVRPort;
    ...
    public class NET_DVR_HKDDNS_STREAM extends Structure {
        ...
        public byte[] byAlias = new byte[HCNetSDKTmp.NAME_LEN];//别名
        public short wDVRSerialLen;//序列号长度
        public byte[] byRes1 = new byte[2];//保留
        public byte[] byDVRSerialNumber = new byte[HCNetSDKTmp.SERIALNO_LEN];//设备序列号
        public byte[] byUserName = new byte[HCNetSDKTmp.NAME_LEN];//设备登录用户名
        public byte[] byPassWord = new byte[HCNetSDKTmp.PASSWD_LEN];//设备登录密码
        public byte byChannel;//设备通道号
...
//2007-11-30 V211支持以下接口 //11
    ...
    long NET_DVR_PicUpload(int lUserID, String sFileName, Pointer lp);
    long NET_DVR_GetPicUploadState(long lUploadHandle);
    long NET_DVR_GetPicUploadProgress(long lUploadHandle);

    boolean NET_DVR_CloseUploadHandle(long lUploadHandle);

    boolean NET_DVR_GetIPCProtoList(int lUserID, Pointer lpDynamicInfo);
    ...
    public static final int NET_DVR_SET_OUTPUT_OSD_CFG = 9207;

<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
            ...
            <el-form-item label="车辆编号" prop="paramdm">
                <el-input v-model="queryParams.paramdm" placeholder="请输入车辆编号" clearable @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item>
        ...
        <el-table v-loading="loading" :data="cdxmbhList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="设备编号" align="center" prop="paramdm" />
            <el-table-column label="设备代码" align="center" prop="sbxh" />
            <el-table-column label="设备名称" align="center" prop="paramname" />
            <el-table-column label="记录条数" align="center" prop="counts" />
...
<script>
import { listCdxmbhByLogNew, getCdxmbh, delCdxmbh, addCdxmbh, updateCdxmbh } from "@/api/w2/cdxmbh";
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            listCdxmbhByLogNew(this.queryParams).then(response => {

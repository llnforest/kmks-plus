<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="cdxmbhList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="扣分代码" align="center" prop="id" />
            <el-table-column label="扣分次数" align="center" prop="counts" />
            <el-table-column label="扣分代码名称" align="center" prop="name" />
        </el-table>
...
<script>
import { listKsxmdmJgByLogNew } from "@/api/w2/ksxmdmJg";
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            listKsxmdmJgByLogNew(this.queryParams).then(response => {
